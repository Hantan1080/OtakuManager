...
#[derive(Debug)]
pub struct OtakuManagerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl OtakuManagerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting OtakuManager processing");
    
    let mut processor = OtakuManagerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = OtakuManagerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = OtakuManagerProcessor::new(false);
